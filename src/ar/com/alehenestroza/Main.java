...
public class Main {
    ...
    public static void main(String[] args) {
	    // Example Sudoku board, 0 represents blank spaces
        int[][] board = {
                {7, 0, 2, 0, 5, 0, 6, 0, 0},
                {0, 0, 0, 0, 0, 3, 0, 0, 0},
                {1, 0, 0, 0, 0, 9, 5, 0, 0},
    ...
    private static boolean rowHasNumber(int[][] board, int number, int row) {
    ...
    private static boolean columnHasNumber(int[][] board, int number, int column) {
        for (int i = 0; i < GRID_SIZE; i++) {
    ...
    private static boolean gridHasNumber(int[][] board, int number, int row, int column) {
    ...
    private static boolean isValidPlacement(int[][] board, int number, int row, int column) {
        return !rowHasNumber(board, number, row) &&
                !columnHasNumber(board, number, column) &&
                !gridHasNumber(board, number, row, column);
    }
